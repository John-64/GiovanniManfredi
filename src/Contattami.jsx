...
>
  ...
  <p>
    <label>Your Name: <input type="text" name="name" className="border" required /></label>
  </p>
  <p>
    <label>Your Email: <input type="email" name="email" className="border" required /></label>
  </p>
  <p>
    <label>Message: <textarea name="message" className="border" required></textarea></label>
  </p>
  <p>
