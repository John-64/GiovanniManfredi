...
function Header({ active, setActive }) {
  ...
  const items = ["Chi sono", "Competenze", "Progetti", "Studio", "Libreria", "Altro"];
  ...
  return (
    <header className="flex justify-between items-center sticky top-0 w-auto px-5 z-100 h-[25px] sm:h-[30px] md:h-[35px] lg:h-[45px] shadow-md 
    bg-white">
      {/* Navigation */}
